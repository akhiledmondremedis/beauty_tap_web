...
const Hero = () => {
    return (
        <section id="home" className="pt-[165px] text-justify">
            <div className="container lg:max-w-[1305px] lg:px-10">
                <div className="-mx-4 flex flex-wrap items-center">
                    ...
                    <div className="w-full px-4 lg:w-7/12">
                        <div className="mb-12 lg:mb-0 lg:max-w-[570px]">
                            <span className="mb-5 block text-lg font-medium leading-tight text-black dark:text-white sm:text-[22px] xl:text-[22px]">
                                BeautyTab – Your All-in-One Beauty & Salon App
                            </span>
                            ...
                            <p className="mb-10 max-w-[475px] text-base leading-relaxed text-gray-600 dark:text-gray-300">
                                Discover, book, and manage beauty services effortlessly. Designed
                                for men’s salons and women’s parlours, BeautyTab connects customers
                                and businesses beautifully.
                            </p>
                            ...
                            <div className="flex flex-wrap items-center">
                                ...
                                <a
                                    href="#"
                                    className="mr-6 mb-6 inline-flex h-[60px] items-center rounded-lg bg-black py-[14px] px-[30px] text-white hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-opacity-90"
                                >
                                    <span className="mr-[18px] border-r border-white/40 pr-[18px] leading-relaxed dark:border-[#BDBDBD]">
                                        Download Now
                                    </span>
                                ...
                                >
                                    <span className="mr-[22px] flex h-[60px] w-[60px] items-center justify-center rounded-full border-2 border-current">
                                        <svg
                                            ...
                                            xmlns="http://www.w3.org/2000/svg"
                                        >
                                            <path d="M13.5 7.06367C14.1667 7.44857 14.1667 8.41082 13.5 8.79572L1.5 15.7239C0.833334 16.1088 -3.3649e-08 15.6277 0 14.8579L6.05683e-07 1.00149C6.39332e-07 0.231693 0.833334 -0.249434 1.5 0.135466L13.5 7.06367Z" />
                                        </svg>
                                    </span>
                    ...
                    <div className="w-full px-4 lg:w-5/12">
                        <div className="relative z-10 mx-auto w-full max-w-[530px] pt-8">
                            <img
                                src={heroLight}
                                alt="hero image"
