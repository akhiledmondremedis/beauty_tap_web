...
import Cta from "../assets/cta-light.png";
            ...
            <div className="w-full self-center px-4 lg:w-1/2">
              ...
              >
                <h2 className="mb-4 text-3xl font-bold text-black dark:text-white sm:text-4xl md:text-[38px] md:leading-tight">
                  Start Your Beauty Journey with BeautyTap
                </h2>
                <p className="mb-10 text-base text-body">
                  Join thousands of customers and salon owners already using BeautyTap to transform their beauty experience.
                </p>
