        ...
        >
          ...
          <form>
            ...
            <div className="mb-[30px]">
              <label className="flex cursor-pointer select-none text-base text-body">
                <input type="checkbox" className="sr-only" />
                <span className="box mr-[10px] mt-[4px] flex h-[22px] w-full max-w-[22px] items-center justify-center rounded-sm border-[.7px] border-stroke bg-white dark:border-stroke-dark dark:bg-black"></span>
                <p>
                  By creating account, you agree to the{" "}
                  <a className="text-primary hover:underline">Terms and Conditions</a> and our{" "}
