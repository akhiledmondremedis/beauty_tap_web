...
const Header = () => {
    return (
        <header className="navbar absolute top-0 left-0 z-50 w-full border-stroke bg-white duration-300 dark:border-stroke-dark dark:bg-black sticky-navbar">
            <div className="container relative max-w-[1400px] mx-auto">
                <div className="flex items-center justify-between">
                    ...
                    <div className="menu-wrapper relative hidden justify-between lg:flex">
                        <nav className="lg:static flex items-center justify-center">
